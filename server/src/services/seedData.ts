...
export const seedPlayers: Player[] = [
  {
    ...
    playerName: 'Naama',
    playerProfileImage: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Naama',
  ...
  },
  {
    ...
    playerName: 'Alex',
    playerProfileImage: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Alex',
  ...
  },
  {
    ...
    playerName: 'Jordan',
    playerProfileImage: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Jordan',
